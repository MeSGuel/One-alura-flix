...
const gamesApiUrl =
  "https://my-json-server.typicode.com/GuiKrieck/alura-flix-api/games";
const categoriesApiUrl =
  "https://my-json-server.typicode.com/GuiKrieck/alura-flix-api/categories";
...
export default function GamesProvider({ children }) {
  ...
  useEffect(() => {
    axios.get(gamesApiUrl).then((response) => {
...
export function useGamesContext() {
  ...
  function addGame(game) {
    axios
      ...
      .catch(() =>
        alert("Houve um erro ao adicionar o jogo, tente novamente!")
      );
  }
  ...
  function updateGame(game) {
    axios
      ...
      .then(() => {
        setGames(
          games.map((thisgame) => (thisgame.id === game.id ? game : thisgame))
        );
  ...
  function deleteGame(game) {
    axios
      ...
      .catch(() =>
        alert("Houve um problema ao deletar o jogo. Tente novamente")
      );
  }
  ...
  function addCategory(category) {
    axios
      ...
      .catch(() =>
        alert("Houve um erro ao adicionar o Sistema, tente novamente!")
      );
  }
